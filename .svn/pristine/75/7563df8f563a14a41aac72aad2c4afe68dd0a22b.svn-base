...
<%-- 		<li class="active"><a
			href="${ctx}/place/ccmBasePlace/form?id=${ccmBasePlace.id}">场所信息<shiro:hasPermission
					name="place:ccmBasePlace:edit">${not empty ccmBasePlace.id?'查看':'添加'}</shiro:hasPermission>
	...
	<form:form id="inputForm" modelAttribute="ccmBasePlace"
		...
		<table>
			...
			<tr>
				<td colspan="2"><label class="control-label"><span class="help-inline"><font color="red">*</font></span>重点场所：</label>
					<div class="controls">
