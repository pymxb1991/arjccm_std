...
<body>
	...
	<ul class="nav nav-tabs">
			...
			<li class="active"><a href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatFloat">流动人口统计</a></li>
			...
			<div class="ToAuto">
				<table class="table table-striped">
					<thead>
						<tr>
							<th>区域</th>
							<th title="本月流动新增人数">本月流动新增人数</th>
							<th title="本月流动总数">本月流动总数</th>
						</tr>
					</thead>
					<tbody class="body">
					</tbody>
			...
			<div class="ToAuto">
				<table class="table table-striped">
					<thead>
						<tr>
							<th>时间</th>
							<th title="新增流动人数">新增流动人数</th>
							<th title="流动总人数">流动总人数</th>
						</tr>
					</thead>
					<tbody class="body">
					</tbody>
	...
	<script type="text/javascript"
		src="${ctxStatic}/ccm/pop/js/ccmFloatInfo.js"></script>
</body>
</html>