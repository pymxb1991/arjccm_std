...
<ul class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 112px"><a class="nav-head" href="${ctx}/place/ccmBasePlace/">数据列表</a></li>
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmBasePlace">
				<tr>
					...
					<td><a class="btnList"
						onclick="parent.LayerDialog('${ctx}/place/ccmBasePlace/form?id=${ccmBasePlace.id}', '详情', '1100px', '700px')">
