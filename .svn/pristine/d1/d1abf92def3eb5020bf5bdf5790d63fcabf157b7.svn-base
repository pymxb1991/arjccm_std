...
<ul class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 112px"><a class="nav-head" href="${ctx}/know/ccmKnowKeyMeeting/">数据列表</a></li>
		...
		<c:forEach items="${page.list}" var="ccmKnowKeyMeeting">
			<tr>
				...
				<shiro:hasPermission name="know:ccmKnowKeyMeeting:edit"><td style="height: 50px">
					...
					<a class="btnList" href="${ctx}/know/ccmKnowKeyMeeting/delete?id=${ccmKnowKeyMeeting.id}" onclick="return confirmx('确认要删除该重要会议吗？', this.href)" title="删除"><i class="icon-remove-sign"></i></a>
