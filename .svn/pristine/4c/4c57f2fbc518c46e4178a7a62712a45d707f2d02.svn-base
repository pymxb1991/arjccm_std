...
<%-- 	<li><a
	...
	<c:if test="${type eq 'hire' }">
		...
		<table border="0px"
			...
			<tr>
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="houseTl" htmlEscape="false" maxlength="50" class="input-xlarge required phone"/>
			...
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>隐患类型：</label>
						<div class="controls">
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>房主现在居住详细地址：</label>
						<div class="controls">
			...
			<tr class="selectHidden">
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>承租人姓名：</label>
						<div class="controls">
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>承租人公民身份号码：</label>
						<div class="controls">
			...
			<tr class="selectHidden">
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>承租人联系方式：</label>
						<div class="controls">
							<form:input path="tenantTl" htmlEscape="false" maxlength="50" class="input-xlarge required phone"/>
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>出租用途：</label>
						<div class="controls">
	...
	<c:if test="${type eq 'house' }">
		<form:form id="inputForm" modelAttribute="ccmPopTenant" action="${ctx}/pop/ccmPopTenant/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<form:hidden path="buildingId"/>
		<form:hidden path="buildingId.id"/>
		<form:hidden path="area.id"/>
			...
			<tr>
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="houseTl" htmlEscape="false" maxlength="50" class="input-xlarge phone"/>
						</div>
					</div>
				</td>
			</tr>
