...
<ul class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 112px"><a class="nav-head" href="${ctx}/org/ccmOrgNpse/list?compType=04">数据列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="ccmOrgNpse" action="${ctx}/org/ccmOrgNpse/?compType=04" method="post" class="breadcrumb form-search clearfix">
		...
		<ul class="ul-form pull-left">
			...
			<li class="first-line"><label>统一社会信用代码：</label>
...
<%--			<li class="clearfix"></li>--%>
	...
	<div class="clearfix pull-right btn-box">
		<a
				...
				class="btn btn-export" style="width: 49px;display:inline-block;float: right;"><i class="icon-export"></i> <span style="font-size: 12px">添加</span></a>
