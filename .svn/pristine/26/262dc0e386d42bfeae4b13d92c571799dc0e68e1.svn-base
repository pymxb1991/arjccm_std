		...
		<c:forEach items="${page.list}" var="ccmHouseDispute">
			<tr>
				...
				<td><shiro:hasPermission name="house:ccmHarmNationalSecurity:edit">
					<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseDispute/form?id=${ccmHouseDispute.id}&hide1=true&hide2=false', '详情', '1200px', '800px')" title="详情"><i class="icon-pencil"></i></a>
					...
					<shiro:hasPermission name="log:ccmLogTail:edit">
						<%-- <a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHouseDispute.id}&relevance_table=ccm_house_dispute', '记录信息', '800px', '660px')" title="记录信息"><i class="icon-print" style="color: cornflowerblue;"></i></a> --%>
