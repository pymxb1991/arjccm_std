...
<div class="context" content="${ctx}"></div>
 <!-- 导入、导出模块 -->
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/pop/ccmWork/">数据列表</a></li>
	</ul>
		...
		<c:forEach items="${page.list}" var="ccmPeople">
			<tr>
				...
				<td><shiro:hasPermission name="pop:ccmPermanent:edit">
						...
						<a class="btnList" href="${ctx}/pop/ccmWork/delete?id=${ccmPeople.id}" onclick="return confirmx('确认要删除该实有人口吗？', this.href)"  title="删除"><i class="icon-remove-sign"></i></a>
				   <a class="btnList"
