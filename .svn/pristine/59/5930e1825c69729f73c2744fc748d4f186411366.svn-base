...
<ul class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 112px"><a class="nav-head" href="${ctx}/live/ccmPlaceLive/1">数据列表</a></li>
	</ul>
...
<%--			<li class="clearfix"></li>--%>
	...
	<div class="clearfix pull-right btn-box">
		<a
				onclick="parent.LayerDialog('${ctx}/live/ccmPlaceLive/form', '添加', '1100px', '700px')"
