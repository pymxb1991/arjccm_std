...
<body style='background:#0B285E;opacity: 0.7'>
	...
	<div id="search" class="form-search hide" style="padding:10px 0 0 13px;">
		...
		<input type="text" class="empty" id="key" name="key" maxlength="50" style="width:110px;background:#0E4C9B;border-color: #0E4C9B">
		<button class="btn btn-primary" id="btn" onclick="searchNode()">搜索</button>
	</div>
	<div id="tree" class="ztree" style="padding:15px 20px;color: #fff"></div>
</body>