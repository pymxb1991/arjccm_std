	...
	<form:form id="inputForm" modelAttribute="ccmEventIncident"
		...
		<table class="table table-bordered table-hover">
			...
			<tr>
				<td>
					<div>
						<label class="control-label">发案地：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						<label class="control-label">案事件名称：</label>
						<div class="controls">
							<form:input path="caseName" htmlEscape="false"
								maxlength="100" class="input-xlarge required" readonly = "true"/>
						</div>
					</div>
				</td>
				<td>
			...
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="address" htmlEscape="false" maxlength="6" class="input-xlarge" readonly = "true"/>
						</div>
					</div>
				</td>
				<td>
					<div>
						...
						htmlEscape="false" maxlength="200" class="input-xlarge" readonly = "true"/>
						</div>
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div>
						<label class="control-label">案事件模块分类：</label>
						<div class="controls">
							<form:select path="eventKind" class="input-xlarge required" disabled="true">
								...
								<form:options items="${fns:getDictList('ccm_event_inci_kind')}"
								 	itemLabel="label" itemValue="value" htmlEscape="false" readonly="readonly"/>
							</form:select>
						</div>
					</div>
				</td>
				<td>
					<div>
						<label class="control-label">案事件类型：</label>
						<div class="controls">
							<form:select path="eventType" class="input-xlarge required" disabled="true">
								<form:option value="" label="" />
			...
			<tr>
				<td>
					<div>
						...
						maxlength="100" class="input-xlarge " readonly = "true"/>
						</div>
					</div>
				</td>
				<td>
					<div>
						<label class="control-label">案事件性质：</label>
						<div class="controls">
							<form:select path="property" class="input-xlarge required" disabled="true">
								<form:option value="" label="" />
			...
			<tr>
				<td>
					<div>
						<label class="control-label">案事件级别：</label>
						<div class="controls">
							<form:select path="eventScale" class="input-xlarge required" disabled="true">
								<form:option value="" label="" />
				...
				<td>
					<div>
						...
						maxlength="80" class="input-xlarge "  readonly = "true"/>
						</div>
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:select path="culPapercode" class="input-xlarge " items="${fns:getDictList('sys_ccm_org_papers')}" itemLabel="label" itemValue="value" htmlEscape="false" disabled="true" readonly = "true">
							</form:select>
						</div>
					</div>
				</td>
				<td>
					<div>
						...
						htmlEscape="false" maxlength="50" class="input-xlarge " readonly = "true"/>
						</div>
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div>
						...
						maxlength="6" class="input-xlarge  digits" type="number" readonly = "true"/>
						</div>
					</div>
				</td>
				<td>
					...
					<div>
						...
						<div class="controls">
							<form:select path="status" class="input-xlarge " disabled="true">
								<form:option value="" label=""/>
								<form:options items="${fns:getDictList('ccm_event_status')}" itemLabel="label" itemValue="value" htmlEscape="false" readonly="readonly"/>
							</form:select>
						</div>
					</div>
				</td>
				<td>
					<div>
						...
						<div class="controls">
							...
							itemValue="value" htmlEscape="false" class="" disabled="true" readonly = "true"/>
						</div>
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div>
						...
						htmlEscape="false" rows="4" maxlength="4000" class="input-xlarge " readonly = "true"/>
						</div>
					</div>
				</td>
				<td>
					...
					<div>
						...
						<div class="controls">
							<form:textarea path="remarks"
								htmlEscape="false" rows="4" maxlength="255" class="input-xlarge " readonly = "true"/>
						</div>
					</div>
				</td>
				<td>
