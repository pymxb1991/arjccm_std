...
<body>
	<ul class="nav nav-tabs">
		<li><a style="width: 140px;text-align:center" href="${ctx}/know/ccmKnowKeyJob/">数据列表</a></li>
		<li class="active" style="width: 140px"><a class="nav-head" href="${ctx}/know/ccmKnowKeyJob/form?id=${ccmKnowKeyJob.id}">数据<shiro:hasPermission name="know:ccmKnowKeyJob:edit">${not empty ccmKnowKeyJob.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="know:ccmKnowKeyJob:edit">查看</shiro:lacksPermission></a></li>
	</ul>
