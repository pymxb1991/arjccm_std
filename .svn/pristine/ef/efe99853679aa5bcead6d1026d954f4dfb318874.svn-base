...
public class CcmPopTenant extends DataEntity<CcmPopTenant> {
	...
	private String tranceId;    // 所属单元id
    ...
    private String buildDoorName;	// 楼门号名称
	...
	public String getBuildDoorName() {
		return buildDoorName;
	}

	public void setBuildDoorName(String buildDoorName) {
		this.buildDoorName = buildDoorName;
	}
	...
	@ExcelField(title="建筑用途", align=2, sort=3, dictType="ccm_str_use")
