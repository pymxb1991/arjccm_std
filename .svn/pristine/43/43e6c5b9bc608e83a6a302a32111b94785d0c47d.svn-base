...
import com.arjjs.ccm.common.service.ServiceException;
...
public class SystemServiceEx extends BaseService implements InitializingBean {
...
//	private SystemAuthorizingRealm systemRealm;
	...
	public boolean  check(User user) {
		return userDao.checkUserByRegister(user)==0?false :true;
	}
