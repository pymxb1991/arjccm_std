...
<div class="context" content="${ctx}"></div>
	<form:form id="searchForm" modelAttribute="ccmHouseDrugs" action="${ctx}/house/ccmHouseDrugs/?tableType='ccmHouseDrugs'" method="post" class="breadcrumb form-search clearfix">
