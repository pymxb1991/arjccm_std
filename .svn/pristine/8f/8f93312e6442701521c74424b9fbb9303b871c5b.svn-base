...
<div class="back-list">
	...
	<form:form id="searchForm" modelAttribute="ccmSeriousCriminalOffense" action="${ctx}/house/ccmSeriousCriminalOffense/?tableType='ccmSeriousCriminalOffense'" method="post" class="breadcrumb form-search clearfix">
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmSeriousCriminalOffense">
				<tr>
					...
					<td>
						<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmSeriousCriminalOffense/form?id=${ccmSeriousCriminalOffense.id}&hide1=true&hide2=false', '详情', '1200px', '800px')" title="详情"><i class="icon-pencil"></i></a>
						...
						<shiro:hasPermission name="log:ccmLogTail:edit">
							<%-- <a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmSeriousCriminalOffense.id}&relevance_table=ccm_serious_criminal_offense', '记录信息', '800px', '660px')" title="记录信息"><i class="icon-print" style="color: cornflowerblue;"></i></a> --%>
