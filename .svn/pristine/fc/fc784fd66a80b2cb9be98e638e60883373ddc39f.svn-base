...
<div class="context" content="${ctx}"></div>
	...
	<form:form id="searchForm" modelAttribute="ccmHouseRectification" action="${ctx}/house/ccmHouseRectification/?tableType='ccmHouseRectification'" method="post" class="breadcrumb form-search clearfix">
		...
		<ul class="ul-form pull-left">
			...
			<li class="first-line"><label>矫正人员编号：</label> <form:input path="rectNum" htmlEscape="false" maxlength="16" class="input-medium" /></li>
			<li class="first-line"><label>矫正类別：</label>
			...
			<li class="second-line"><label >案事件类別：</label>
	...
	<table id="contentTable"
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmHouseRectification">
				<tr>
					<td width="100px"><img src="${ccmHouseRectification.images}" style="height:50px;" class="pimg"/></td>
					...
					<td><shiro:hasPermission name="house:ccmHouseRectification:edit">
						<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseRectification/form?id=${ccmHouseRectification.id}&hide1=true&hide2=false', '详情', '1200px', '800px')" title="详情"><i class="icon-pencil"></i></a>
					    ...
					    <shiro:hasPermission name="log:ccmLogTail:edit">
							<%-- <a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHouseRectification.id}&relevance_table=ccm_house_rectification', '记录信息', '800px', '660px')" title="记录信息"><i class="icon-print" style="color: cornflowerblue;"></i></a> --%>
