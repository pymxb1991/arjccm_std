					...
					<div>
							...
							<div class="controls">
								<%--<sys:treeselect id="organization" name="organization" value="${ccmPartyActivity.organization}" labelName="" labelValue="${ccmPartyActivity.organization}"
									...
									<form:select path="organization" class="input-xlarge required">
			...
			<tr>
				<td style="padding: 8px;border: 1px dashed #CCCCCC"  colspan="2">
					<div>
						...
						<div class="controls">
							<form:input path="activitTitle" htmlEscape="false" rows="4" maxlength="200" class="input-xxlarge required" style="width:400px"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
			...
			<tr>
				<td style="padding: 8px;border: 1px dashed #CCCCCC"  colspan="2">
					<div>
						...
						<div class="controls">
							<form:textarea path="activitContent" htmlEscape="false" rows="4" class="input-xxlarge required" style="width:863px"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
