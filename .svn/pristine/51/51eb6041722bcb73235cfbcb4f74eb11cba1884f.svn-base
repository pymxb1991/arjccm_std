...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/house/ccmHouseSchoolrim/popList" >校园周边重点人员列表</a></li>
		<li class="active"><a href="">校园周边重点人员信息</a></li>
		<%-- <li><a
			href="${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmPeople.id}&relevance_table=ccm_house_schoolrim">跟踪信息<shiro:hasPermission
		...
		<shiro:hasPermission name="pop:ccmPeople:edit">
			<ul class="nav nav-pills ulz">
				...
				<c:if test="${ccmPeople.isRelease==1}">
						...
						<li><a class="znul"
							onclick="parent.LayerDialog('${ctx}/house/ccmHouseDangerous/specialform?id=${ccmPeople.id}', '危险品从业人员标记', '1200px', '900px')" style="color: white">危险品从业人员标记</a></li>
					</c:if> 
