...
<body>
	...
	<form:form id="inputForm" modelAttribute="ccmFontUser" action="${ctx}/cms/ccmFontUser/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="no" htmlEscape="false" maxlength="100" class="input-xlarge card"/>
			</div>
   ...
   <div class="controls">
                <sys:treeselect id="area" name="areaComId.id" value="${ccmFontUser.areaComId.id}" labelName="areaComId.name" labelValue="${ccmFontUser.areaComId.name}"
     ...
     <span class="help-inline"><font color="red" id="show1">*</font></span>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="phone" htmlEscape="false" maxlength="200" class="input-xlarge simplePhone"/>
			</div>
		</div>
		<div class="control-group">
