...
<div class="context" content="${ctx}"></div>
	<ul class="nav nav-tabs" >
		<li style="float:right;"><a style="background-color:#9f3df8;color:white;" href="${ctx}/contradiction/ccmContradictionDeal/?isSupervise=1">督办事件</a></li>
		<li style="float:right;"><a style="background-color:#25cf71;color:white;" href="${ctx}/contradiction/ccmContradictionDeal/?handleStatus=03">已办事件</a></li>
		<li style="float:right;"><a style="background-color:#eea807;color:white;" href="${ctx}/contradiction/ccmContradictionDeal/?handleStatus=02">办理中事件</a></li>
		<li style="float:right;"><a style="background-color:#f83d3d;color:white;" href="${ctx}/contradiction/ccmContradictionDeal/?handleStatus=01">待办事件</a></li>
		<li style="float:right;" class="active"><a style="background-color: #3bb4f2;color: white;" href="${ctx}/contradiction/ccmContradictionDeal">事件处理列表</a></li>
	</ul> 
