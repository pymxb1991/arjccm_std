			...
			<tr>
				...
				<td>
					<div class="control-group" style="border:none;margin-top:15px;">
						...
						<div class="controls">
							<form:input path="equipmentNum" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
			...
			<tr>
				<td>
					<div class="control-group" style="border:none;margin-top:15px;">
						...
						<div class="controls">
							<form:input path="equipmentFrequency" htmlEscape="false" maxlength="64" class="input-xlarge required number"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
				<td>
					<div class="control-group" style="border:none;margin-top:15px;">
						...
						<div class="controls">
							<form:radiobuttons path="equipmentState" items="${fns:getDictList('ccm_remote_equipment_state')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
