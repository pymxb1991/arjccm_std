...
<ul class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 112px"><a class="nav-head" href="${ctx}/live/ccmPlaceLive/3">数据列表</a></li>
	</ul>
	...
	<ul>
		<li class="btns"><a
				onclick="parent.LayerDialog('${ctx}/live/ccmPlaceLive/form?type=3', '添加', '1100px', '700px')"
	...
	<table id="contentTable"
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmPlaceLive">
				<tr>
				<td width="200px"><img src="${ccmPlaceLive.ccmBasePlace.placePicture}"
						 class="pic-size pimg"/></td>
					<td><a class="btnList"
						onclick="parent.LayerDialog('${ctx}/live/ccmPlaceLive/form?type=3&id=${ccmPlaceLive.id}', '编辑', '1100px', '700px')">
					...
					<td class="tp">${ccmPlaceLive.address}</td>
					...
					<shiro:hasPermission name="live:ccmPlaceLive:edit">
						<td>
							...
							onclick="return confirmx('确认要删除该营业厅吗？', this.href)" title="删除"><i
