...
<div class="context" content="${ctx}"></div>
	...
	<form:form id="searchForm" modelAttribute="ccmHousePetition" action="${ctx}/house/ccmHousePetition/?tableType='ccmHousePetition'" method="post" class="breadcrumb form-search clearfix">
		...
		<c:forEach items="${page.list}" var="ccmHousePetition">
			<tr>
				...
				<shiro:hasPermission name="house:ccmHousePetition:edit">
					<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHousePetition/form?id=${ccmHousePetition.id}&hide1=true&hide2=false', '详情', '1200px', '800px')" title="详情"><i class="icon-pencil"></i></a>
				...
				<shiro:hasPermission name="log:ccmLogTail:edit">
							<%-- <a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHousePetition.id}&relevance_table=ccm_house_petition', '记录信息', '800px', '660px')" title="记录信息"><i class="icon-print" style="color: cornflowerblue;"></i></a> --%>
