...
<body>
	<ul class="nav nav-tabs">
		<li><a style="width: 140px;text-align:center" href="${ctx}/know/ccmKnowGovernmentAffairs/">数据列表</a></li>
		<li class="active" style="width: 140px"><a class="nav-head" href="${ctx}/know/ccmKnowGovernmentAffairs/form?id=${ccmKnowGovernmentAffairs.id}">数据<shiro:hasPermission name="know:ccmKnowGovernmentAffairs:edit">${not empty ccmKnowGovernmentAffairs.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="know:ccmKnowGovernmentAffairs:edit">查看</shiro:lacksPermission></a></li>
	</ul>
