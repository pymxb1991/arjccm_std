	...
	<table id="contentTable"
		...
		<tbody>
			<c:forEach items="${page.list}" var="pbsFlowwork">
				<tr>
					<td><a
						href="${ctx}/flow/dealPc/applyHandle?id=${pbsFlowwork.SBindkey}">
					...
					<td><a title="审核"
						href="${ctx}/flow/dealPc/applyHandle?id=${pbsFlowwork.SBindkey}"><i
