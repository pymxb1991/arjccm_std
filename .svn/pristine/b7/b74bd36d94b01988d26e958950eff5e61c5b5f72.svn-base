...
<ul class="nav nav-tabs">
    <li class="active"  style="width: 140px"><a  class="nav-head" href="${ctx}/event/ccmEventIncident/dispatch">任务派遣列表</a></li>
</ul>
<form:form id="searchForm" modelAttribute="ccmEventIncident"
           action="${ctx}/event/ccmEventIncident/dispatch" method="post"
...
<%--                            onclick="incident('historyLegacy')"><i class="icon-tags"></i>历史遗留</a></li>--%>
<%--        <li class="btns"><a class="btn btn-primary" type="button"--%>
<%--                            style="background-color: #28bece;border-color: #28bece;" onclick="incident('ratify')"><i--%>
<%--                class=" icon-user"></i>领导批示</a></li>--%>
<%--        <li class="btns"><a class="btn btn-primary" type="button"--%>
<%--                            style="background-color: #d81e06;border-color: #d81e06;" onclick="incident('urgent')"><i--%>
<%--                class="icon-bolt"></i>加 急</a></li>--%>
<%--        <li class="btns"><a class="btn btn-primary" type="button"--%>
<%--                            style="background-color: rgb(250, 141, 20);border-color: rgb(250, 141, 20);"--%>
<%--                            onclick="incident('stick')"><i class="icon-pushpin"></i>置 顶</a></li>--%>
...
<%--                   onclick="parent.LayerDialog('${ctx}/event/ccmEventIncident/form?id=${ccmEventIncident.id}', '','1200px', '800px')">--%>
                <div style=" width: auto;overflow: hidden;text-overflow: ellipsis;">${ccmEventIncident.caseName}</div>
<%--                </a>--%>
            </td>
