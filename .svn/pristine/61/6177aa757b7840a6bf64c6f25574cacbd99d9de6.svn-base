...
<body>
	...
	<form:form  id="inputForm" modelAttribute="plmPurchaseDeclare" action="${ctx}/purchase/plmPurchaseDeclare/save" method="post" class="form-horizontal">
      ...
      <h2>采购申报申请单</h2>
		...
		<table id="table" class="table table-condensed">
			...
			<tr>
				...
				<td colspan="2" style="width: 30%">${fns:getDictLabel(plmPurchaseDeclare.plmAct.isSup, 'yes_no', '')}</td>
				<td class="trtop" colspan="2" style="width: 20%">督办人</td>
				<td colspan="2" style="width: 30%">${plmPurchaseDeclare.plmAct.supExe.name}</td>
			</tr>		
			<tr>
		...
		<!-- 自定义标签   把流转信息用纸质表的方式显示   colspan:表格意见部分跨列数    WEB-INF/tags/act/histoicTable.tag   -->
			...
			<act:histoicTable procInsId="${plmPurchaseDeclare.act.procInsId}" colspan="6" titleColspan="2"  />
