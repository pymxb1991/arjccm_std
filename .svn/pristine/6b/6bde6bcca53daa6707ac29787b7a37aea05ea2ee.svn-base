...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/exam/pbsExampaper/?sWay=1">试卷信息列表</a></li>
		<li class="active"><a
			href="${ctx}/exam/pbsExampaper/form?id=${pbsExampaper.id}">试卷信息<shiro:hasPermission
	...
	<form:form id="inputForm" modelAttribute="pbsExampaper"
		action="${ctx}/exam/pbsExampaper/save" method="post"
