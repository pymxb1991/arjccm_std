...
<body>
	...
	<form:form target="_parent" id="inputForm" modelAttribute="plmCalendar"
		action="${ctx}/calendar/plmCalendar/save" method="post"
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="beginTime" id="beginTime" type="text"
								...
								onclick="WdatePicker({dateFmt:'HH:mm',isShowClear:true});" /> <span
			...
			<tr>
					...
					<div class="control-group">
						...
						<div class="controls">
							<form:radiobuttons path="importance"
								items="${fns:getDictList('calendar_import')}" itemLabel="label"
				...
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<form:radiobuttons path="priority"
								items="${fns:getDictList('calendar_priority')}"
