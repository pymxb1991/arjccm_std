...
<body>
	...
	<form:form id="inputForm" modelAttribute="plmAct" action="${ctx}/act/plmAct/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">详情url：</label>
			<div class="controls">
				<form:input path="formUrl" htmlEscape="false" maxlength="256" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="status" class="input-xlarge ">
					...
					<form:options items="${fns:getDictList('plm_act_status')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="isSup" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">督办人id：</label>
			<div class="controls">
				<sys:treeselect id="supExe" name="supExe.id" value="${plmAct.supExe.id}" labelName="supExe.name" labelValue="${plmAct.supExe.name}"
		...
		<div class="control-group">
			<label class="control-label">督办明细：</label>
			<div class="controls">
				<form:input path="supDetail" htmlEscape="false" maxlength="256" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="act:plmAct:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
