...
<body>
	<ul class="nav nav-tabs">
		<li><a style="width: 140px;text-align:center" href="${ctx}/know/ccmKnowKeyActivity/">数据列表</a></li>
		<li class="active" style="width: 140px"><a class="nav-head" href="${ctx}/know/ccmKnowKeyActivity/form?id=${ccmKnowKeyActivity.id}">数据<shiro:hasPermission name="know:ccmKnowKeyActivity:edit">${not empty ccmKnowKeyActivity.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="know:ccmKnowKeyActivity:edit">查看</shiro:lacksPermission></a></li>
	</ul>
