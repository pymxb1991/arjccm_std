...
<div id="content" class="row-fluid">
	...
	<div id="right">
		<iframe id="officeContent" src="${ctx}/partyactivity/ccmPartyActivity/list?type=1&id=&parentIds=" width="100%" height="91%" frameborder="0"></iframe>
	</div>
</div>
	...
	var setting = {
		...
		callback:{
			onClick:function(event, treeId, treeNode){
				...
				$('#officeContent').attr("src","${ctx}/partyactivity/ccmPartyActivity/list?type=1&officeId="+id);
			}
		}
	};
