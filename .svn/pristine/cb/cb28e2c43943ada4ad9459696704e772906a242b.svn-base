 ...
 * @version 2018-09-26
 */
public class CcmHarmNationalSecurity extends DataEntity<CcmHarmNationalSecurity> {
	
	private static final long serialVersionUID = 1L;
	private String peopleId;		// 实有人口（id）
	private String suspicionType;		// 嫌疑类型
	private Office reportOffice;		// 呈报单位

	private String offName;		// 单位名称
	private String offId;		// 单位id
	...
	private String superviseStatus  ;		// 监管状态
	private String discoveryWay  ;		// 发现途径
	...
	public CcmHarmNationalSecurity() {
		super();
	}

	public CcmHarmNationalSecurity(String id){
		super(id);
	}
	...
	@ExcelField(title="嫌疑类型", align=2, sort=6 ,dictType="suspicion_type_dict")
	...
	@JsonIgnore
	@ExcelField(title="呈报单位", align=2, sort=7 )
	public Office getReportOffice() {
		return reportOffice;
	}
   
	public void setReportOffice(Office reportOffice) {
		this.reportOffice = reportOffice;
	}
	
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@ExcelField(title="呈报时间", align=2, sort=8 )
