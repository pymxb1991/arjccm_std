...
<div class="context" content="${ctx}"></div>
	<form:form id="searchForm" modelAttribute="ccmHouseDangerous" action="${ctx}/house/ccmHouseDangerous/?tableType='ccmHouseDangerous'" method="post" class="breadcrumb form-search clearfix">
		...
		<c:forEach items="${page.list}" var="ccmHouseDangerous">
			<tr>
				...
				<td><shiro:hasPermission name="house:ccmHouseDangerous:edit">
	    			<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseDangerous/form?id=${ccmHouseDangerous.id}&hide1=true&hide2=false', '详情', '1200px', '800px')" title="详情"><i class="icon-pencil"></i></a>
					...
					<%-- <a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHouseDangerous.id}&relevance_table=ccm_house_dangerous', '记录信息', '800px', '660px')" title="记录信息"><i class="icon-print" style="color: cornflowerblue;"></i></a> --%>
