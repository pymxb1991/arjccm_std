...
<script type="text/javascript"  >$(document).ready(function() {
    ...
    $("#menu a.menu").click(function() {
    	...
    	if(aHref=="/arjccm/a/sys/map/indexMap"){
        ...
        if ($(menuId).length > 0) {
            ...
            function(data) {
                ...
                $(menuId + " .accordion-body a").click(function() {
                	//判断是否地地图标注,综治队伍
                	var aHref=$(this).attr('href');
                	if(aHref=="/arjccm/a/house/ccmHouseBuildmanage/ToMap"||aHref=="/arjccm/a/view/vCcmTeam/index"){
                		$('#right').css('padding','0px');
                		$("#right").width(
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<div class="brand">
					<a href="${ctx}/sys/map/statIndexCom" target=""><span id="productName"
						>${fns:getConfig('productName')}</span></a>
				</div>
				<ul id="userControl" class="nav pull-right">
					<li><a href="${ctx}/" title="返回主面板">主面板</a></li>
					<li><a href="${ctx}" title="访问电子沙盘系统">电子沙盘</a></li>
					<li><a href="${ctx}" title="访问视频融合系统">视频融合</a></li>
					<li><a href="${ctx}/sys/map/statIndexCom" title="访问大数据主页"><i class="icon-home"></i></a></li>
			...
			<div id="content" class="row-fluid">
				...
				<div id="right">
					<iframe id="mainFrame" name="mainFrame" src=""
						...
						width="100%" height="650" allowfullscreen="true" allowtransparency="true"></iframe>
				</div>
			</div>
