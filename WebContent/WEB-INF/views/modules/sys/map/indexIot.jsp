...
<!-- 					<input onclick="ShowHideDivL(this)" style="background-color: #19a7f0 !important;border: 0px;" class="btn btn-primary" type="button" value="收起">
 -->				<span ></span>
				...
				<!-- 内容列表 -->
			 	...
			 	<div style="color:#fff;padding: 16px 16px 3px;">资源业务</div>
				 	<div class="accordion-heading">
					<ul class="nav nav-tabs">
						<li id="devPage" class="active"><a href="#devTree" data-toggle="tab">区域资源</a></li>
						<li id="fencePage"><a href="#workTree" data-toggle="tab">业务</a></li>
					</ul>
				   </div>
				   ...
				   <div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane fade" id="workTree">
						<div>
