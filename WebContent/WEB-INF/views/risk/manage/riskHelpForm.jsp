...
<body>
	...
	<form:form id="inputForm" modelAttribute="riskHelp" action="${ctx}/manage/riskHelp/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="antistop" htmlEscape="false" rows="1" maxlength="100" class="input-xxlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="description" htmlEscape="false" rows="5" maxlength="256" class="input-xxlarge "/>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckeditor uploadPath="/manage/riskHelp" replace="content" height="200"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">重要程度：</label>
			<div class="controls">
				<form:select path="importance" class="input-xlarge required">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckfinder input="file" type="files" uploadPath="/manage/riskHelp" selectMultiple="true"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="manage:riskHelp:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
