...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/report/riskEventGreat/listDatabase">重大事项库列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="riskEventGreat" action="${ctx}/report/riskEventGreat/listDatabase" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="riskEventGreat">
			<tr>
				<td><a href="${ctx}/report/riskEventGreat/formDatabase?id=${riskEventGreat.id}">
					${riskEventGreat.name}
				</a></td>
				<td>
