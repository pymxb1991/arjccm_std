...
<body>
	...
	<form:form id="inputForm" modelAttribute="plmCheckDetial" action="${ctx}/storage/plmCheckDetial/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="stoId" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
		...
		<div class="control-group">
			<label class="control-label">物资类别2：</label>
			<div class="controls">
				<form:input path="typeChild" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">物资剩余数量（主要是耗材）：</label>
			<div class="controls">
				<form:input path="remainingQuantity" htmlEscape="false" maxlength="64" class="input-xlarge  digits"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">盘点结果：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="storage:plmCheckDetial:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
