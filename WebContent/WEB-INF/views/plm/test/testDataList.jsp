...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/test/testData/">业务数据表列表</a></li>
		<shiro:hasPermission name="test:testData:edit"><li><a href="${ctx}/test/testData/form">业务数据表添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="testData">
			<tr>
				...
				<shiro:hasPermission name="test:testData:edit"><td>
					...
					<a href="${ctx}/test/testData/delete?id=${testData.id}" onclick="return confirmx('确认要删除该业务数据表吗？', this.href)">删除</a>
