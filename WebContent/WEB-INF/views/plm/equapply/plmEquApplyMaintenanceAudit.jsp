...
<script type="text/javascript"
	src="${ctxStatic}/plm/equapply/plmEquApplyForm.js"></script>
<script type="text/javascript">
...
<body>
	<br />
	<form:form  id="inputForm" modelAttribute="plmEquApplyMaintenance"
		action="${ctx}/equapply/plmEquApplyMaintenance/saveAudit" method="post"
		...
		<table id="tabletop" class="table">
			<tr>
				...
				<td class="tabletop" colspan="3">申请人所在部门：<u>&nbsp;&nbsp;
		...
		<table id="table" class="table   table-condensed">
			<tr>
				...
				<td colspan="6"><form:textarea path="applyBody"
						htmlEscape="false" rows="8" value="${plmEquApply.applyBody}"
						class="input-xxlarge " cssStyle="width:76.296%" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="trtop" colspan="2">规格型号</td>
				<td class="trtop" colspan="1">物资类别</td>
				<td class="trtop" colspan="1">物资子类</td>
			</tr>
			<c:forEach items="${plmEquEquipmentList }" var="plmEquEquipmentList">
			<tr>
				<td class="trtop" colspan="2">${plmEquEquipmentList.code}</td>
				<td class="trtop" colspan="2">${plmEquEquipmentList.name}</td>
				<td class="trtop" colspan="2">${plmEquEquipmentList.spec}</td>
				<td class="trtop" colspan="1">${fns:getDictLabel(plmEquEquipmentList.typeId, 'plm_equipment_type', '')}
				</td>
				<td class="trtop" colspan="1">${fns:getDictLabel(plmEquEquipmentList.typeChild, 'plm_equipment_type_child', '')}</td>
			</tr>
			</c:forEach>
			...
			<act:histoicTable procInsId="${plmEquApply.procInsId}" colspan="8"
				titleColspan="2" />
