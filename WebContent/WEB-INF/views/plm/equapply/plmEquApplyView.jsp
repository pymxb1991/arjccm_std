...
<script type="text/javascript">
	...
	function downloadFile(){
	    ...
	    form.attr("action",'${ctx}/equapply/plmEquApply/printPdfIo');
	...
	<form:form id="inputForm" modelAttribute="plmEquApply"
		...
		<table id="table" class="table   table-condensed"
			...
			<tr>
				...
				<td colspan="5">${plmEquApplyDetail.applyBody }</td>
			</tr>
			<tr>
				<td class="trtop">备注：</td>
				<td colspan="5">${plmEquApplyDetail.remarks}</td>
			</tr>
			<tr>
