	...
	<script type="text/javascript" src="${ctxStatic}/plm/room/plmRoomMeetingApplyForm.js"></script> 
		<script type="text/javascript">
			...
			function downloadFile(){
			    ...
			    form.attr("action",'${ctx}/logistics/plmRoomMeetingApply/printPdfIo');
...
<body>
	<form:form id="inputForm" style="margin: 30px 100px;" modelAttribute="plmRoomApply" action="${ctx}/logistics/plmRoomMeetingApply/save" method="post" class="form-horizontal">
