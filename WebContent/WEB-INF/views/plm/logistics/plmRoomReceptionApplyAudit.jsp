...
<head>
	...
	<script type="text/javascript"
		src="${ctxStatic}/plm/room/plmRoomReceptionApplyForm.js"></script>
...
<body>
	<form:form id="inputForm" style="margin: 30px 100px;" modelAttribute="plmRoomApply"
		action="${ctx}/logistics/plmRoomReceptionApply/saveAudit"
