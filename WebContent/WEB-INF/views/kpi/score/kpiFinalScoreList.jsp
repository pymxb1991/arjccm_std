...
<div class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 140px"><a class="nav-head" href="${ctx}/score/kpiFinalScore/">数据列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="kpiFinalScore" action="${ctx}/score/kpiFinalScore/" method="post" class="breadcrumb form-search clearfix">
