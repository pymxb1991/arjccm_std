...
<body>
	<ul class="nav nav-tabs">
		<li><a style="width: 140px;text-align:center" href="${ctx}/know/ccmKnowKeyFile/">数据列表</a></li>
		<li class="active" style="width: 140px"><a  class="nav-head"href="${ctx}/know/ccmKnowKeyFile/form?id=${ccmKnowKeyFile.id}">数据<shiro:hasPermission name="know:ccmKnowKeyFile:edit">${not empty ccmKnowKeyFile.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="know:ccmKnowKeyFile:edit">查看</shiro:lacksPermission></a></li>
	</ul>
