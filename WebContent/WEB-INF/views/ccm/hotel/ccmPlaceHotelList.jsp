...
<ul class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 112px"><a class="nav-head" href="${ctx}/hotel/ccmPlaceHotel/01">数据列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="ccmPlaceHotel"
		action="${ctx}/hotel/ccmPlaceHotel/01" method="post"
...
<%--			<li class="clearfix"></li>--%>
	...
	<div class="clearfix pull-right btn-box">
		<a
				onclick="parent.LayerDialog('${ctx}/hotel/ccmPlaceHotel/form?type=01', '添加', '1100px', '700px')"
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmPlaceHotel">
				<tr>
					...
					<td>${fns:getDictLabel(ccmPlaceHotel.hotelRank, 'ccm_hotel_level', '无')}</td>
					<td><fmt:formatDate value="${ccmPlaceHotel.updateDate}"
							pattern="yyyy-MM-dd HH:mm:ss" /></td>
					<shiro:hasPermission name="hotel:ccmPlaceHotel:edit">
						<td>
						<a class="btnList"
							onclick="parent.LayerDialog('${ctx}/event/ccmEventIncident/listCheck?placeId=${ccmPlaceHotel.basePlaceId}', '事件关联', '1100px', '700px')"
