...
<div class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 140px"><a class="nav-head" href="${ctx}/education/ccmPlaceEducation/03">数据列表</a></li>
	</ul>

	<form:form id="searchForm" modelAttribute="ccmPlaceEducation"
		action="${ctx}/education/ccmPlaceEducation/03" method="post"
...
<%--			<li class="clearfix"></li>--%>
	...
	<div class="clearfix pull-right btn-box">
		<a
				onclick="parent.LayerDialog('${ctx}/education/ccmPlaceEducation/form?type=03', '添加', '1100px', '700px')" style="width: 49px;display:inline-block;float: right;"
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmPlaceEducation">
				<tr>
					...
					<td>${ccmPlaceEducation.managerNumber}</td>
					<td>${fns:getDictLabel(ccmPlaceEducation.isFree, 'ccm_place_free', '无')}</td>
