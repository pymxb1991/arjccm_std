...
<body>
	<ul class="nav nav-tabs">
		<%-- 		<li class="active"><a
			href="${ctx}/education/ccmPlaceEducation/form?id=${ccmPlaceEducation.id}">美术馆或博物院信息<shiro:hasPermission
	...
	<form:form id="inputForm" modelAttribute="ccmPlaceEducation"
		action="${ctx}/education/ccmPlaceEducation/save/03" method="post"
		...
		<h4 class="tableName">博物馆或美术馆信息</h4>
		<table>
			<tr>
				<td><label class="control-label"><span class="help-inline"><font color="red">*</font></span>管理人员数量（人）：</label>
					<div class="controls">
						<form:input path="managerNumber" htmlEscape="false"
									maxlength="100" class="input-xlarge required"  type="number"/>
					</div></td>
