...
<body>
	...
	<form:form id="inputForm" modelAttribute="ccmPeople"
		...
		<c:if test="${not empty ccmPeople.id}">
			<br>
			<h4>特殊标记信息：</h4>
			<table id="mark" border="1px"
				style="border-color: #CCCCCC; border: 1px solid #CCCCCC; width: 100%">
				<tr>
		...
		<div class="form-actions">
			...
			<input id="btnCancel" class="btn" type="button" onclick="" value="返 回"
