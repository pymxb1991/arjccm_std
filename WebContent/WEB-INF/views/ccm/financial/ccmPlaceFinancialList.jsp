...
<ul class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 112px"><a class="nav-head" href="${ctx}/financial/ccmPlaceFinancial/">数据列表</a></li>
	</ul>
...
<%--			<li class="clearfix"></li>--%>
	...
	<div class="clearfix pull-right btn-box">
		<a
				onclick="parent.LayerDialog('${ctx}/financial/ccmPlaceFinancial/form', '添加', '1100px', '700px')"
	...
	<table id="contentTable"
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmPlaceFinancial">
				<tr>
					<td width="200px"><img
						src="${ccmPlaceFinancial.ccmBasePlace.placePicture}"
						 class="pic-size pimg"/></td>
					<td><a class="btnList"
						onclick="parent.LayerDialog('${ctx}/financial/ccmPlaceFinancial/form?id=${ccmPlaceFinancial.id}', '编辑', '1100px', '700px')">
					...
					<td>${fns:getDictLabel(ccmPlaceFinancial.bankType, 'ccm_bank_type', '无')}</td>
					<td><fmt:formatDate value="${ccmPlaceFinancial.createDate}"
							pattern="yyyy-MM-dd HH:mm:ss" /></td>
					<shiro:hasPermission name="financial:ccmPlaceFinancial:edit">
						<td>
						<a class="btnList"
							onclick="parent.LayerDialog('${ctx}/event/ccmEventIncident/listCheck?placeId=${ccmPlaceFinancial.basePlaceId}', '事件关联', '1100px', '700px')"
