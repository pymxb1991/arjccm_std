...
<body>
	...
	<form:form id="inputForm" modelAttribute="sysDicts" action="${ctx}/sys/sysDicts/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="parent" name="parent.id" value="${sysDicts.parent.id}" labelName="parent.label" labelValue="${sysDicts.parent.label}"
					title="父级编号" url="/sys/sysDicts/treeData" extId="${sysDicts.id}" cssClass="" allowClear="true"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="sort" htmlEscape="false" class="input-xlarge required number"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:sysDicts:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
