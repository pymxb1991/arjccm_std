...
<div class="context" content="${ctx}"></div>
	...
	<form:form id="searchForm" modelAttribute="ccmHouseHeresy" action="${ctx}/house/ccmHouseHeresy/?tableType='ccmHouseHeresy'" method="post" class="breadcrumb form-search clearfix">
		...
		<c:forEach items="${page.list}" var="ccmHouseHeresy">
			<tr>
				...
				<td><shiro:hasPermission name="house:ccmHouseHeresy:edit">
					<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseHeresy/form?id=${ccmHouseHeresy.id}&hide1=true&hide2=false', '详情', '1200px', '800px')" title="详情"><i class="icon-pencil"></i></a>
				...
				<shiro:hasPermission name="log:ccmLogTail:edit">
					<%-- <a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHouseHeresy.id}&relevance_table=ccm_house_heresy', '记录信息', '800px', '660px')" title="记录信息"><i class="icon-print" style="color: cornflowerblue;"></i></a> --%>
