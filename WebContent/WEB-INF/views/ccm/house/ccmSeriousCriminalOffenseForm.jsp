...
<body>
	<form:form id="inputForm" modelAttribute="ccmSeriousCriminalOffense" action="${ctx}/house/ccmSeriousCriminalOffense/save" method="post" class="form-horizontal hide1">
			...
			<tr>
				<td rowspan="1">
					<div>
						...
						<div class="controls">
							<form:textarea path="superviseSituation" htmlEscape="false" rows="4" maxlength="2084" class="input-xlarge " />
						</div>
					</div>
				</td>
				<td>
