...
<div id="content" class="row-fluid">
	...
	<div id="right">
		<iframe id="officeContent" src="${ctx}/partyreport/ccmPartyReport/list?type=1&id=&parentIds=" width="100%" height="91%" frameborder="0"></iframe>
	</div>
</div>
	...
	var setting = {
		...
		callback:{
			onClick:function(event, treeId, treeNode){
				...
				var type = $("#type").val()
				$('#officeContent').attr("src","${ctx}/partyreport/ccmPartyReport/list?type="+type+"&officeId="+id); 
			}
		}
	};
