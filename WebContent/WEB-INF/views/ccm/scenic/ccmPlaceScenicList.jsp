		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmPlaceScenic">
				<tr>
					...
					<td>${fns:getDictLabel(ccmPlaceScenic.scenicRank, 'ccm_scenic_level', '无')}</td>
					<td>${fns:getDictLabel(ccmPlaceScenic.isFree, 'ccm_place_free', '无')}</td>
					<td><fmt:formatDate value="${ccmPlaceScenic.updateDate}"
