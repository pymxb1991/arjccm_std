...
<ul class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 112px"><a class="nav-head" href="${ctx}/hospital/ccmPlaceHospital/01">数据列表</a></li>
	</ul>
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmPlaceHospital">
				<tr>
					...
					<td>${fns:getDictLabel(ccmPlaceHospital.relevanceOrg, 'ccm_buss_cate', '无')}</td>
					<td>${fns:getDictLabel(ccmPlaceHospital.hospitalLevel, 'ccm_hospital_level', '无')}</td>
					<td><a
