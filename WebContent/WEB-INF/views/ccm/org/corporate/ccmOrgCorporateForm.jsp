...
<%-- 	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/org/ccmOrgNpse/formData?id=${ccmOrgNpse.id}&compType=01">法人企业<shiro:hasPermission name="org:ccmOrgNpse:edit">${not empty ccmOrgNpse.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="org:ccmOrgNpse:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/> --%>
			...
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="compArea" htmlEscape="false" class="input-xlarge number positivenumber required" />
						</div>
					</div>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="companyNum" htmlEscape="false" maxlength="6" class="input-xlarge number positivenumber digits required"/>
						</div>
					</div>
				</td>
			</tr>
			...
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="partyMem" htmlEscape="false" maxlength="6" class="input-xlarge number positivenumber digits required"/>
						</div>
					</div>
				</td>
				<td>
			...
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="laborUnionNum" htmlEscape="false" maxlength="6" class="input-xlarge number positivenumber digits required"/>
						</div>
					</div>
				</td>
				<td>
			...
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="youthLeagOrgaNum" htmlEscape="false" maxlength="6" class="input-xlarge number positivenumber digits required" />
						</div>
					</div>
				</td>
				<td>
			...
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="womenNum" htmlEscape="false" maxlength="6" class="input-xlarge number positivenumber digits required"/>
						</div>
					</div>
				</td>
				<td>
			...
			<tr class="selectHidden">
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="survCameNum" htmlEscape="false" maxlength="5" class="input-xlarge number positivenumber digits"/>
						</div>
					</div>
				</td>
			</tr>
			<tr class="selectHidden">
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="xRayNum" htmlEscape="false" maxlength="4" class="input-xlarge number positivenumber digits"/>
						</div>
					</div>
				</td>
				<td>
