...
<body>
	<%-- <ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/org/ccmOrgNpse/formData?id=${ccmOrgNpse.id}&compType=04">事业单位<shiro:hasPermission name="org:ccmOrgNpse:edit">${not empty ccmOrgNpse.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="org:ccmOrgNpse:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/> --%>
	<form:form id="inputForm" modelAttribute="ccmOrgNpse" action="${ctx}/org/ccmOrgNpse/save" method="post" class="form-horizontal">
		...
		<table border="0px"
			...
			<tr>
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>事业单位名称：</label>
						<div class="controls">
			...
			<tr>
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>事业单位地址：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>事业单位联系方式：</label>
						<div class="controls">
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>事业单位员工数：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>事业单位负责人姓名：</label>
						<div class="controls">
				...
				<td>
					<div>
						<label class="control-label">事业单位负责人联系方式：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="youthLeagOrgaNum" htmlEscape="false" maxlength="6" class="input-xlarge digits required" type="number" />
						</div>
					</div>
				</td>
				<td>
