...
<div id="content" class="row-fluid">
	...
	<div id="right">
		<iframe id="officeContent" src="${ctx}/partyactivity/ccmPartyActivity/list?type=2&id=&parentIds=" width="100%" height="91%" frameborder="0"></iframe>
	</div>
</div>
	...
	var setting = {
		...
		callback:{
			onClick:function(event, treeId, treeNode){
				...
				$('#officeContent').attr("src","${ctx}/partyactivity/ccmPartyActivity/list?type=2&officeId="+id);
			}
		}
	};
