...
<div class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 140px"><a class="nav-head" href="${ctx}/citycomponents/ccmLand/">数据列表</a></li>
		<shiro:hasPermission name="citycomponents:ccmLand:edit"><li><a style="width: 140px;text-align:center" href="${ctx}/citycomponents/ccmLand/form">数据添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="ccmLand">
			<tr>
				...
				<shiro:hasPermission name="citycomponents:ccmLand:edit"><td style="height: 50px">
    				<a class="btnList" href="${ctx}/citycomponents/ccmLand/form?id=${ccmLand.id}" title="修改"><i class="icon-pencil"></i></a>
					<a class="btnList" href="${ctx}/citycomponents/ccmLand/delete?id=${ccmLand.id}" onclick="return confirmx('确认要删除该土地吗？', this.href)" title="删除"><i class="icon-remove-sign"></i></a>
