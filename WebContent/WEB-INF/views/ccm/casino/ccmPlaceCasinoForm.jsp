...
<body>
	...
	<form:form id="inputForm" modelAttribute="ccmPlaceCasino"
		action="${ctx}/casino/ccmPlaceCasino/save/01" method="post"
		...
		<h4 class="tableName">公园和体育场信息</h4>
		<table>
			<tr>
				<td><label class="control-label"><span class="help-inline"><font color="red">*</font></span>管理人员数量（人）：</label>
					<div class="controls">
						<form:input path="managerNumber" htmlEscape="false"
							maxlength="100" class="input-xlarge required number digits"/>

					</div>
				</td>
				<td><label class="control-label"><span class="help-inline"><font color="red">*</font></span>是否收费：</label>
					<div class="controls">
