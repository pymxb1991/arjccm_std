...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a
			href="${ctx}/event/ccmEventIncident/historyLegacyForm?id=${ccmEventIncident.id}">事件管理<shiro:hasPermission
	...
	<form:form id="inputForm" modelAttribute="ccmEventIncident"
		action="${ctx}/event/ccmEventIncident/historyLegacySave" method="post"
		...
		<table border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC; padding: 10px; width: 100%;">
				...
				<td style="padding: 8px;border: 0px dashed #CCCCCC">
					<div>
						...
						<div class="controls">
							...
							notAllowSelectParent="true" cssStyle="" cssClass=""/>
			...
			<tr>
				<td style="padding: 8px;border: 0px dashed #CCCCCC">
					<div>
						<label class="control-label">作案人数(人)：</label>
						<div class="controls">
				...
				<td style="padding: 8px;border: 0px dashed #CCCCCC">
					<div>
						<label class="control-label">在逃人数(人)：</label>
						<div class="controls">
			...
			<tr>
				<td style="padding: 8px;border: 0px dashed #CCCCCC">
					<div>
						<label class="control-label">抓捕人数(人)：</label>
						<div class="controls">
