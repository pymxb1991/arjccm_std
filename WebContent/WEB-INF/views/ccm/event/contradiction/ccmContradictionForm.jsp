...
<body>
	<form:form id="inputForm" modelAttribute="ccmEventIncidentPreview"
		action="${ctx}/contradiction/ccmContradiction/save/4" method="post"
		...
		<table>
			...
			<tr>
				...
				<td><label class="control-label"><span class="help-inline"><font
						color="red" >*</font></span>上报人联系电话：</label>
					<div class="controls">
			...
			<tr>
				<td><label class="control-label"><span class="help-inline"><font color="red">*</font></span>所属网格：</label>
					<div class="controls">
						...
						<span class="help-inline"><font color="red" id="show1"></font></span></td>
			...
			<tr>
				<td style="width: 50%;"><label class="control-label"><span class="help-inline"><font color="red">*</font></span>事件类别：</label>
					<div class="controls">
				...
				<td style="width: 50%;"><label class="control-label"><span class="help-inline"><font color="red">*</font></span>事件规模：</label>
					<div class="controls">
		...
		<div>
			...
			<table id="EventDetailTable" style="display: none">
				<tr>
					<td><label class="control-label">案（事)件性质：</label>
						<div class="controls">
