...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/event/wechat/ccmWechatEventReply/list?event.id=${ccmWechatEventReply.event.id}&type=chatEvent">微信回复列表</a></li>
		<shiro:hasPermission name="event:wechat:ccmWechatEventReply:edit"><li><a href="${ctx}/event/wechat/ccmWechatEventReply/form?event.id=${ccmWechatEventReply.event.id}&type=chatEvent">微信回复添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="ccmWechatEventReply">
			<tr>
				<td><a href="${ctx}/event/wechat/ccmWechatEventReply/form?id=${ccmWechatEventReply.id}&type=chatEvent">
