...
<%--		<li style="float:right;"><a style="background-color:#9f3df8;color:white;" href="${ctx}/event/ccmEventCasedeal/supervise?isSupervise=1">督办事件</a></li>--%>
		...
		<li style="float:right;" class="active"><a style="background-color:#eea807;color:white;" href="${ctx}/event/ccmEventCasedeal/?handleStatus=02">办理中事件</a></li>
...
<%--						</c:if>--%>
					...
					<shiro:hasPermission name="event:ccmEventCasedeal:edit">
						...
						<a  class="btnList"
							href="${ctx}/event/ccmEventCasedeal/delete?handleSta=02&id=${ccmEventCasedeal.id}"
