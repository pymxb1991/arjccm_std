...
<ul class="back-list">
	...
	<form:form id="searchForm" modelAttribute="ccmEventIncidentPreview"
		action="${ctx}/preview/ccmEventIncidentPreview/5" method="post"
		...
		<ul class="ul-form pull-left">
			...
			<li class="second-line"><label>事件规模：</label> 
				<form:select path="caseScope"
					class="input-medium">
					<form:option value="" label="全部" />
...
<%--			<li class="clearfix"></li>--%>
	...
	<div class="clearfix pull-right btn-box">
		<a
				onclick="parent.LayerDialog('${ctx}/preview/ccmEventIncidentPreview/form/5', '添加', '1100px', '600px')"
