...
<input type="hidden" id="hasPermission" value="${fns:getUser().hasPermission}"/>
	...
	<ul class="nav nav-tabs">
		<li class="active" style="width: 140px"><a class="nav-head" href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatHarmNational">数据统计</a></li>
		<li><a style="width: 140px;text-align:center" href="javascript:;" data-href="${ctx}/house/ccmHarmNationalSecurity" onclick="HasSecret(this)">数据列表</a></li>
	</ul>
	<div class="row-fluid">
			...
			<div class="ToAuto">
				<table class="table table-striped">
					<thead>
						<tr>
							<th>区域</th>
							<th title="本月危害国家安全活动嫌疑新增人数">本月危害国家安全活动嫌疑新增人数</th>
							<th title="本月危害国家安全活动嫌疑总数">本月危害国家安全活动嫌疑总数</th>
						</tr>
					</thead>
					<tbody class="body">
					</tbody>
			...
			<div class="ToAuto">
				<table class="table table-striped">
					<thead>
						<tr>
							<th>时间</th>
							<th title="新增危害国家安全活动嫌疑人数">新增危害国家安全活动嫌疑人数</th>
							<th title="危害国家安全活动嫌疑总人数">危害国家安全活动嫌疑总人数</th>
						</tr>
					</thead>
					<tbody class="body">
					</tbody>
