...
<input type="hidden" id="hasPermission" value="${fns:getUser().hasPermission}"/>
	...
	<ul class="nav nav-tabs">
		<li class="active" style="width: 140px"><a class="nav-head" href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatDispute">数据统计</a></li>
		<li><a style="width: 140px;text-align:center" href="javascript:;" data-href="${ctx}/house/ccmHouseDispute" onclick="HasSecret(this)">数据列表</a></li>
	</ul>
	<div class="row-fluid">
			...
			<div class="ToAuto">
				<table class="table table-striped">
					<thead>
						<tr>
							<th>区域</th>
							<th title="本月闹事行凶报复嫌疑新增人数">本月闹事行凶报复嫌疑新增人数</th>
							<th title="本月闹事行凶报复嫌疑总数">本月闹事行凶报复嫌疑总数</th>
						</tr>
					</thead>
					<tbody class="body">
					</tbody>
			...
			<div class="ToAuto">
				<table class="table table-striped">
					<thead>
						<tr>
							<th>时间</th>
							<th title="新增闹事行凶报复嫌疑人数">新增闹事行凶报复嫌疑人数</th>
							<th title="闹事行凶报复嫌疑总人数">闹事行凶报复嫌疑总人数</th>
						</tr>
					</thead>
					<tbody class="body">
					</tbody>
	...
	<script type="text/javascript"
		src="${ctxStatic}/ccm/pop/js/ccmDisputeInfo.js"></script>
</body>
</html>