...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/vote/pbsVoteTopic/listsurvey">调查主题信息列表</a></li>
		<li class="active"><a
			href="${ctx}/vote/pbsVoteTopic/form?id=${pbsVoteTopic.id}">调查主题信息<shiro:hasPermission
		...
		<c:if test="${not empty pbsVoteTopic.id}">
			<li class=""><a
				href="${ctx}/vote/pbsVoteSubject/addsubjectform?sParentid=${pbsVoteTopic.id}&sParentid.SBelongfunc=1">调查题目信息添加</a></li>
		</c:if>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="pbsVoteTopic"
		...
		<form:hidden path="id" />
		<form:hidden path="sBelongfunc" value="1" />
		...
		<div class="control-group">
			<label class="control-label"><font color="red">*&nbsp;</font>调查开始时间：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><font color="red">*&nbsp;</font>调查结束时间：</label>
			<div class="controls">
