...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a>问卷列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="pbsVoteTopic"
		action="${ctx}/vote/pbsVotePc/investigationlist" method="post"
			...
			<c:forEach items="${page.list}" var="pbsVoteTopic">
				<li>
				  <div class="list0">
				  	<h5>标题名称</h5>
				  	<h6>
				  	<a href="${ctx}/vote/pbsVotePc/investigationInfo?id=${pbsVoteTopic.id}">${pbsVoteTopic.SName}</a></h6>
				  </div>
				  <div class="list1">
				  	<h5>是否完成</h5>
				  	<h6>
				  ...
				  <div  class="list4">
				  	<h5>操作</h5>
				  	<h6><a href="${ctx}/vote/pbsVotePc/investigationInfo?id=${pbsVoteTopic.id}"><i class="icon-circle-arrow-right"></i></a></h6>
				  </div>
				</li>
			</c:forEach>
		</ul>
