			...
			<tr>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:input path="grabberName" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
				...
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:select path="grabberType" class="input-xlarge required">
			...
			<tr>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:input path="grabberNum" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:select path="accessType" class="input-xlarge required">
								<form:option value="" label="全部"/>
			...
			<tr>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:input path="resourcesNum" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:input path="grabberIp" htmlEscape="false" maxlength="64" class="input-xlarge required ip"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
			...
			<tr>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:input path="grabberPort" htmlEscape="false" maxlength="64" class="input-xlarge required number"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:input path="monitorNum" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
			...
			<tr>
				<td colspan="2">
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:input path="grabberPassway" htmlEscape="false" maxlength="16" class="input-xlarge required number"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
			...
			<tr>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:input path="grabberLongitude" htmlEscape="false" maxlength="64" class="input-xlarge "/>
						</div>
					</div>
				</td>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:input path="grabberLatitude" htmlEscape="false" maxlength="64" class="input-xlarge "/>
						</div>
					</div>
				</td>
			</tr>
