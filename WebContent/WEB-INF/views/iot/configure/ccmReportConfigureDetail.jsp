...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#reportMusicPreview").next().css("display","none");
			$("#reportMusicPreview").next().next().css("display","none");
			$("#reportAimagesPreview").next().css("display","none");
			$("#reportAimagesPreview").next().next().css("display","none");
			$("#topRimagesPreview").next().css("display","none");
			$("#topRimagesPreview").next().next().css("display","none");
			$("#iconPreview").next().css("display","none");
			$("#iconPreview").next().next().css("display","none");
		});
	</script>
</head>
<body>
	...
	<form:form id="inputForm" modelAttribute="ccmReportConfigure" action="${ctx}/configure/ccmReportConfigure/save" method="post" class="form-horizontal">
		...
		<h3 class="tableName" style="margin:10px 0 10px 0;"><i class="icon-hand-right"></i>地图及左侧列表展示信息</h3>
			...
			<tr>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:select path="reportType" class="input-xlarge " disabled="true">
				...
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							...
							<sys:ckfinder input="reportAimages" type="images" uploadPath="/configure/ccmReportConfigure" selectMultiple="true"/>
						</div>
					</div>
				</td>
			</tr>
			...
			<tr>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:radiobuttons path="topRtype" items="${fns:getDictList('ccm_configure_top_rtype')}" itemLabel="label" itemValue="value" htmlEscape="false" class="" disabled="true"/>
						</div>
					</div>
				</td>
				<td>
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:radiobuttons path="topRstype" items="${fns:getDictList('ccm_configure_top_rstype')}" itemLabel="label" itemValue="value" htmlEscape="false" class="" disabled="true"/>
						</div>
					</div>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							<form:select id="topColor" path="topColor" class="input-xlarge " onchange="selectColor()" disabled="true">
								<form:option value="" label="全部"/>
				...
				<td colspan="2">
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							...
							<sys:ckfinder input="topRimages" type="images" uploadPath="/configure/ccmReportConfigure" selectMultiple="true"/>
						</div>
					</div>
				</td>
			</tr>
				...
				<td colspan="2">
					<div class="control-group" style="border:none;margin-top:10px;">
						...
						<div class="controls">
							...
							<sys:ckfinder input="icon" type="images" uploadPath="/configure/ccmReportConfigure" selectMultiple="true"/>
						</div>
					</div>
				</td>
			</tr>
