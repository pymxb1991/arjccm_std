...
;(function($){
    $.fn.pgwMenu = function(options) {
        ...
        var setup = function() {
            ...
            pgwMenu.plugin.removeClass('pgwMenuCustom').addClass('pm-links');
            ...
            if (pgwMenu.config.viewMoreEnabled) {
                pgwMenu.plugin.append('<div class="pm-viewMore" style="display:inline-block"><a href="javascript:void(0)">' + pgwMenu.config.viewMoreLabel + '</a><ul id="menu1"></ul></div>');
            }
        };
                ...
                if (type == 'viewmore') {
                    ...
                    pgwMenu.plugin.find('.pm-links > li').show().each(function() {
                        if (viewMoreMenuWidth + $(this).outerWidth(true) < pluginMaxWidth) {
                            ...
                            pgwMenu.plugin.find('.pm-viewMore > ul').append($(this).clone(true).show());
                            $(this).hide();
                        }
                    });
