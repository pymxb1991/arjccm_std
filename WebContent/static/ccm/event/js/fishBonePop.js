...
//            }
            ...
            $.each(this, function(name, value) {
                ...
                if (name == 'tailCase') {
            	  ...
            	  if (name == 'tailPerson') {
                       var li = $("<li>处理人员：" + value + "</li>").css("border-left","1px solid "+color);
                       li.appendTo(ul);
                  }
            	  if (name == 'more1') {
                      var li = $("<li>联系方式：" + value + "</li>").css("border-left","1px solid "+color);
                      li.appendTo(ul);
                 }
                if (name == 'tailTime') {
                	var clock="";
                	...
                	if(value!=null){
                	   ...
                	   var li = $("<li>时间：" + clock + "</li>").css("border-left","1px solid "+color);
                       li.appendTo(ul);
                ...
                if (name == 'id') {
					...
					ul[0].onclick=function(){
                		parent.LayerDialog1('',ctx+'/log/ccmLogTail/formPro?id='+idx, '处理详情', '800px', '660px')
					}
                }
//                if (name == 'remarks') {
//                	ul[0].id=idx
...
//                    	parent.LayerDialog1('',ctx+'/log/ccmLogTail/formPro?id='+idx, '处理详情', '800px', '660px')
//                    }
//                    var li = $("<li>备注信息：" + value + "</li>").css("border-left","1px solid "+color);
//                    li.appendTo(ul);
//                }
            });
          //封装审理时间和案号
