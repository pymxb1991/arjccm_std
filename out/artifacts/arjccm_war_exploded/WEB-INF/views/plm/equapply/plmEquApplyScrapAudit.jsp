...
<body>
	<br />
	<form:form id="inputForm" modelAttribute="plmEquApplyScrap"
		action="${ctx}/equapply/plmEquApplyScrap/saveAudit" method="post"
		...
		<table id="table" class="table   table-condensed">
			<tr>
				...
				<td colspan="6"><form:textarea path="applyBody"
						htmlEscape="false" rows="6" value="${plmEquApply.applyBody}"
