...
<body>
	<form:form id="inputForm" modelAttribute="plmApplyForReimbursement" action="${ctx}/travel/plmApplyForReimbursement/saveAudit" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table id="table" class="table table-condensed">
			...
			<c:if test="${plmApplyForReimbursement.plmAct.isSup eq '0'}">
				<tr>
					<td class="trtop" colspan="1">是否督办</td>
					<td colspan="5">${fns:getDictLabel(plmApplyForReimbursement.plmAct.isSup, 'yes_no', '')}</td>
				</tr>	
			</c:if>
			<c:if test="${plmApplyForReimbursement.plmAct.isSup eq '1'}">
				<tr>
					<td class="trtop" colspan="1">是否督办</td>
					<td colspan="2">${fns:getDictLabel(plmApplyForReimbursement.plmAct.isSup, 'yes_no', '')}</td>
					<td class="trtop" colspan="1">督办人</td>
					<td colspan="2">${plmApplyForReimbursement.plmAct.supExe.name}</td>
				</tr>		
				<tr>
			...
			<c:if test="${plmApplyForReimbursement.plmAct.isSup ne '1'}">
				<tr>
