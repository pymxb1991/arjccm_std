...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/policy/plmKnowPolicyAct/?types=2">政策法规列表</a></li>
		<li class="active"><a
			href="${ctx}/policy/plmKnowPolicyAct/form?id=${plmKnowPolicy.id}">政策法规<shiro:hasPermission
					name="policy:plmKnowPolicyAct:edit">${not empty plmKnowPolicy.id?'修改':'添加'}</shiro:hasPermission>
				<shiro:lacksPermission name="policy:plmKnowPolicyAct:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="plmKnowPolicy"
		...
		<table id="table" class="table   table-condensed"
			...
			<tr>
				...
				<td colspan="6"><form:textarea name="content"
						htmlEscape="false" path="content" rows="4" maxlength="200"
						class="input-xxlarge" /> <sys:ckeditor replace="content"
						uploadPath="/policy/plmKnowPolicyAct" /></td>
			</tr>
			<tr>
