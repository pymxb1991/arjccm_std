...
<body>
	<ul class="nav nav-tabs">
		...
		<li><a href="${ctx}/exam/testPC/officeSelfList">学习自测</a></li>
		<li class="active"><a>自测错题库</a></li>
	</ul>
	<br />
	...
	<form:form id="inputForm" method="post" class="form-horizontal"
		...
		<div class="control-group">
			<label class="control-label">错题总数：</label>
			<div class="controls">
				<label class="title">${errorNum}个</label>
			</div>
		</div>
		...
		<c:forEach items="${pbsExampaperitems}" var="item" begin="0"
			varStatus="s">
			<div class="control-group">
				<label class="control-label exam">${s.index+1}.</label>
