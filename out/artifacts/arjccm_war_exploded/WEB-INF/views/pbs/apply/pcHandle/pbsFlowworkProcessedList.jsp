...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="">我已处理</a></li>
	</ul>

	<form:form id="searchForm" modelAttribute="pbsFlowwork"
		action="${ctx}/flow/dealPc/dealtFinishList" method="post"
...
<%-- 			<form:input path="sFlowid.sName" htmlEscape="false" maxlength="64" class="input-medium" /></li> --%>
	...
	<table id="contentTable"
		...
		<tbody>
			<c:forEach items="${page.list}" var="pbsFlowwork">
				<tr>
					<td><a
						href="${ctx}/flow/dealPc/dealtFinishInfo?id=${pbsFlowwork.SBindkey}">
					...
					<td><a title="查看"
						href="${ctx}/flow/dealPc/dealtFinishInfo?id=${pbsFlowwork.SBindkey}"><i
