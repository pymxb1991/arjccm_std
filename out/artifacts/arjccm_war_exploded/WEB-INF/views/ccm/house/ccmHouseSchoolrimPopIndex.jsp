...
<body>
	...
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="ccmHouseSchoolrim" src="${ctx}/house/ccmHouseSchoolrim/popList?id=" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	...
	<script type="text/javascript">
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
					...
					if(type=="1"){
						$('#ccmHouseSchoolrim').attr("src","${ctx}/house/ccmHouseSchoolrim/popList?id="+treeNode.id);
					}
				}
			}
		};
