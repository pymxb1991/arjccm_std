...
<%-- 	<ul class="nav nav-tabs">
	...
	<form:form id="inputForm" modelAttribute="ccmHousePsychogeny" action="${ctx}/house/ccmHousePsychogeny/save" method="post" class="form-horizontal hide1">
		...
		<table border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC; padding: 10px; width: 100%;">
			...
			<tr>
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>监护人姓名：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>监护人联系方式：</label>
						<div class="controls">
			...
			<tr>
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>治疗情况：</label>
						<div class="controls">
