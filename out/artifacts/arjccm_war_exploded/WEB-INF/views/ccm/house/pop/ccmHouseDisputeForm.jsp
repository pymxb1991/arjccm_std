...
<body>
	<form:form id="inputForm" modelAttribute="ccmHouseDispute"
		action="${ctx}/house/ccmHouseDispute/save" method="post"
			...
			<tr>
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="disputer" htmlEscape="false" maxlength="32"
								class="input-xlarge " />
						</div>
					</div>
				</td>
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="disputerAddr" htmlEscape="false"
			...
			<tr>
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="disputerPhone" htmlEscape="false"
								maxlength="16" class="input-xlarge phone" />
						</div>
					</div>
				</td>
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="disputeCase" htmlEscape="false"
			...
			<tr>
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<input name="firstDate" type="text" readonly="readonly"
			...
			<tr>
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="discoverer" htmlEscape="false" maxlength="32"
								class="input-xlarge " />
						</div>
					</div>
				</td>
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="discoverId" htmlEscape="false" maxlength="20"
			...
			<tr>
				...
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="possibleBehave" htmlEscape="false"
			...
			<tr>
				...
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="helpName" htmlEscape="false" maxlength="32"
								class="input-xlarge " />
						</div>
					</div>
				</td>
			...
			<tr>
				...
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="crimeHistory" htmlEscape="false"
								maxlength="1024" class="input-xlarge " />
						</div>
					</div>
				</td>
		...
		<div class="form-actions">
			<shiro:hasPermission name="house:ccmHouseDispute:edit">
