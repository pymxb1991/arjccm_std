		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmHouseRectification">
				<tr>
					...
					<td class="tc"><a onclick="parent.LayerDialog('${ctx}/house/ccmHouseRectification/form?id=${ccmHouseRectification.id}', '信息', '1200px', '900px')">${ccmHouseRectification.name}</a></td>
					<td class="tc">${ccmHouseRectification.ident}</td>
					<td class="tc">${fns:getDictLabel(ccmHouseRectification.sex, 'sex', '')}</td>
					<td class="tc">${ccmHouseRectification.telephone}</td>
					<td class="tc">${ccmHouseRectification.rectNum}</td>
					<td class="tc">${fns:getDictLabel(ccmHouseRectification.rectType, 'ccm_core_sort', '')}</td>
					...
					<td class="tc"><shiro:hasPermission name="house:ccmHouseRectification:edit">
					    ...
					    <shiro:hasPermission name="log:ccmLogTail:edit">
							<a class="btnList" onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHouseRectification.id}&relevance_table=ccm_house_rectification', '记录信息', '800px', '660px')" 
