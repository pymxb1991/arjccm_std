...
<div class="back-list">
	...
	<form:form id="searchForm" modelAttribute="ccmHarmNationalSecurity" action="${ctx}/house/ccmHarmNationalSecurity/?tableType='ccmHarmNationalSecurity'" method="post" class="breadcrumb form-search clearfix">
		...
		<c:forEach items="${page.list}" var="ccmHarmNationalSecurity">
			<tr>
				...
				<td><shiro:hasPermission name="house:ccmHarmNationalSecurity:edit">
					<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHarmNationalSecurity/form?id=${ccmHarmNationalSecurity.id}&hide1=true&hide2=false', '详情', '1200px', '800px')" title="详情"><i class="icon-pencil"></i></a>
					<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHarmNationalSecurity/form?id=${ccmHarmNationalSecurity.id}&hide1=false&hide2=true', '走访记录', '1200px', '500px')" title="走访记录"><i class="icon-list-ul"></i></a>
					</shiro:hasPermission> <shiro:hasPermission name="log:ccmLogTail:edit">
					<%-- <a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHarmNationalSecurity.id}&relevance_table=ccm_harm_national_security', '记录信息', '800px', '660px')" title="记录信息"><i class="icon-print" style="color: cornflowerblue;"></i></a> --%>
					<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHarmNationalSecurity.id}&relevance_table=ccm_harm_national_security', '添加记录', '800px', '660px')" title="添加记录"><i class="icon-plus"></i></a>
