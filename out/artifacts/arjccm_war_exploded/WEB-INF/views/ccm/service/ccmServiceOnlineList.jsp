			...
			<tr>
				...
				<shiro:hasPermission name="service:ccmServiceOnline:edit"><td style="height: 50px">
					<c:if test="${etype eq '1'}">
						...
						<a class="btnList" href="${ctx}/service/ccmServiceOnline/delete?id=${ccmServiceOnline.id}" onclick="return confirmx('确认要删除该在线办事吗？', this.href)" title="删除"><i class="icon-remove-sign"></i></a>
					</c:if>
