				...
				<div>
					...
					<div class="controls">
						<form:select path="familyOrigin" class="input-xlarge ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictList('family_background')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
					</div>
				</div>
			</td>
				...
				<div>
					...
					<div class="controls">
						<form:select path="individualStatus" class="input-xlarge ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictList('person_id')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
					</div>
				</div>
			</td>
				...
				<div>
					...
					<div class="controls">
						<form:select path="firstLineSituation" class="input-xlarge ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictList('front_line')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
					</div>
				</div>
			</td>
				...
				<div>
					...
					<div class="controls">
						<form:select path="newOrder" class="input-xlarge ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictList('new_class')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
					</div>
				</div>
			</td>
				...
				<div>
					...
					<div class="controls">
						<form:select path="contactInfo" class="input-xlarge ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictList('contact')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
					</div>
				</div>
			</td>
		...
		<tr>
			...
			<td style="padding: 8px;border: 1px dashed #CCCCCC" >
				<div>
					...
					<div class="controls">
						<form:radiobuttons path="partRelaVillaFlag" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
					</div>
				</div>
			</td>
		</tr>
		<tr>
			...
			<td style="padding: 8px;border: 1px dashed #CCCCCC" >
				<div>
					...
					<div class="controls">
						<form:radiobuttons path="partRelaFarmerFlag" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
					</div>
				</div>
			</td>
		</tr>
