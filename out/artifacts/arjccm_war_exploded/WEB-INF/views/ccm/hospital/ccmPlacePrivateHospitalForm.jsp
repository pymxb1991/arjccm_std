...
<body>
	<ul class="nav nav-tabs">
		<%-- 		<li class="active"><a
			href="${ctx}/hospital/ccmPlaceHospital/form?id=${ccmPlaceHospital.id}">私人诊所信息<shiro:hasPermission
	...
	<form:form id="inputForm" modelAttribute="ccmPlaceHospital"
		action="${ctx}/hospital/ccmPlaceHospital/save/02" method="post"
		...
		<table>
			<tr>
				...
				<td><label class="control-label">诊疗科目：</label>
					<div class="controls">
						<form:input path="diagnosisSubject" htmlEscape="false"
							maxlength="255" class="input-xlarge " />
					</div></td>
			</tr>
			<tr>
				<td><label class="control-label">申请人姓名：</label>
					<div class="controls">
						<form:input path="proposerName" htmlEscape="false" maxlength="255"
							class="input-xlarge " />
					</div></td>
				<td><label class="control-label">申请人职称：</label>
					<div class="controls">
						<form:input path="proposerLevel" htmlEscape="false"
							maxlength="255" class="input-xlarge " />
					</div>
					</div></td>
			</tr>
			<tr>
				<td><label class="control-label">医生数（人）：</label>
					<div class="controls">
						<form:input path="doctorNumber" htmlEscape="false" maxlength="255"
							class="input-xlarge " />
					</div></td>
				<td><label class="control-label">护士数（人）：</label>
					<div class="controls">
						<form:input path="nurseNumber" htmlEscape="false" maxlength="255"
							class="input-xlarge " />
					</div></td>
			</tr>
			<tr>
				<td><label class="control-label">注册资金（元）：</label>
					<div class="controls">
