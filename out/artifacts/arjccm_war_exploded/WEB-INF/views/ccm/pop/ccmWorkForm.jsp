...
<body>
	<ul class="nav nav-tabs">
		<li><a style="width: 140px;text-align:center" href="${ctx}/pop/ccmWork">数据列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="ccmPeople" action="${ctx}/pop/ccmWork/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
