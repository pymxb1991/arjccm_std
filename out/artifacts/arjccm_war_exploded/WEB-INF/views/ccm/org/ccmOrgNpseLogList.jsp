...
<%--					${ccmOrgNpse.compName}</a>--%>
				...
				<td><shiro:hasPermission name="org:ccmOrgNpseLog:edit">
				...
				<a class="btnList" href="${ctx}/org/ccmOrgNpseLog/delete?id=${ccmOrgNpse.id}" onclick="return confirmx('确认要删除该物流安全重点吗？', this.href)"  title="删除"><i class="icon-remove-sign"></i></a>
				</shiro:hasPermission> <shiro:hasPermission name="log:ccmLogTail:edit">
<%--				<a class="btnList" onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmOrgNpse.id}&relevance_table=ccm_org_npseLog', '添加记录', '800px', '660px')"--%>
