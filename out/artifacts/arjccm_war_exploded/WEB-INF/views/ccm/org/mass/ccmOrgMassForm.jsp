	...
	<form:form id="inputForm" modelAttribute="ccmOrgNpse" action="${ctx}/org/ccmOrgNpse/save" method="post" class="form-horizontal">
		...
		<table border="0px"
			...
			<tr>
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>社团名称：</label>
						<div class="controls">
			...
			<tr>
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>社团地址：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>社团联系方式：</label>
						<div class="controls">
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>社团员工数：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>社团负责人姓名：</label>
						<div class="controls">
