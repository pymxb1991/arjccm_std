...
<body>
	...
	<form:form id="inputForm" modelAttribute="ccmOrgControl" action="${ctx}/org/ccmOrgControl/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="area" name="area.id" value="${ccmOrgControl.area.id}" labelName="area.name" labelValue="${ccmOrgControl.area.name}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="orgnature" class="input-xlarge ">
		...
		<div class="form-actions">
			<shiro:hasPermission name="org:ccmOrgControl:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
