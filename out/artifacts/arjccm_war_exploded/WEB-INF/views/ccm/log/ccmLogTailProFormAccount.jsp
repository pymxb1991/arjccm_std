...
<body>
	<ul class="nav nav-tabs">
		...
		<li><a href="${ctx}/pop/ccmPeople/listAccountFind?id=${ccmLogTail.relevanceId}">户籍人口列表</a></li>
		<li><a href="${ctx}/pop/ccmPeople/formAccount?id=${ccmLogTail.relevanceId}">户籍人口修改</a></li>
	...
	<form:form id="inputForm" modelAttribute="ccmLogTail"
		action="${ctx}/log/ccmLogTail/savePro" method="post"
