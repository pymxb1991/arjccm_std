...
<ul class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 112px"><a class="nav-head" href="${ctx}/attendance/ccmWorkerAttendance/leavelist">数据列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="ccmWorkerAttendance" action="${ctx}/attendance/ccmWorkerAttendance/leavelist" method="post" class="breadcrumb form-search clearfix">
...
<%--			<li class="clearfix"></li>--%>
	...
	<div class="clearfix pull-right btn-box">
		<shiro:hasPermission name="attendance:ccmWorkerAttendance:edit">
			<input id="btnSubmit" class="btn btn-export" style="width: 75px;display:inline-block;float: right;margin-left: 20px;margin-right: 14px;margin-bottom: 20px" type="button" value="添加" onclick="parent.LayerDialog('${ctx}/attendance/ccmWorkerAttendance/leaveform','添加','1100px','700px')"/>
		...
		<c:forEach items="${page.list}" var="ccmWorkerAttendance">
			<tr>
				...
				<shiro:hasPermission name="attendance:ccmWorkerAttendance:edit"><td style="height: 50px">
					...
					<a  class="btnList" href="${ctx}/attendance/ccmWorkerAttendance/delete?id=${ccmWorkerAttendance.id}&deleteType=2" onclick="return confirmx('确认要删除该社工考勤登记吗？', this.href) title="删除"><i class="icon-remove-sign"></i></a>
