...
<body>
	...
	<form:form id="inputForm" modelAttribute="ccmPlaceCasino"
		action="${ctx}/casino/ccmPlaceCasino/save/02" method="post"
		...
		<h4 class="tableName">网吧信息</h4>
		<table>
			<tr>
				<td><label class="control-label"><span class="help-inline"><font color="red">*</font></span>电脑数量（个）：</label>
					<div class="controls">
						<form:input path="computerNumber" htmlEscape="false"
