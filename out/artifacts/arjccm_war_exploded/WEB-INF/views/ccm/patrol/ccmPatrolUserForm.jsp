...
<body>
	...
	<form:form id="inputForm" modelAttribute="ccmPatrolUser" action="${ctx}/patrol/ccmPatrolUser/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="user" name="user.id" value="${ccmPatrolUser.user.id}" labelName="user.name" labelValue="${ccmPatrolUser.user.name}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="patrol:ccmPatrolUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
