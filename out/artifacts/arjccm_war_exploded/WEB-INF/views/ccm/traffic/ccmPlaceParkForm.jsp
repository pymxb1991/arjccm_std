...
<body>
	<ul class="nav nav-tabs">
		<%-- 		<li class="active"><a
			href="${ctx}/traffic/ccmPlaceTraffic/form?id=${ccmPlaceTraffic.id}">停车场信息<shiro:hasPermission
	...
	<form:form id="inputForm" modelAttribute="ccmPlaceTraffic"
		action="${ctx}/traffic/ccmPlaceTraffic/save/02" method="post"
		...
		<h4 class="tableName">停车场信息</h4>
		<table>
			<tr>
				<td><label class="control-label">停车位收费（元/小时）：</label>
					<div class="controls">
						<form:input path="parkSpacePay" htmlEscape="false" maxlength="255"
							class="input-xlarge " />
					</div></td>
				<td><label class="control-label">收费封顶（元/小时）：</label>
					<div class="controls">
						<form:input path="parkSpaceMaxpay" htmlEscape="false"
							maxlength="255" class="input-xlarge " />
					</div></td>
			</tr>
			<tr>
				<td colspan="2"><label class="control-label">停车位数量：</label>
					<div class="controls">
						<form:input path="parkSpaceNumber" htmlEscape="false"
