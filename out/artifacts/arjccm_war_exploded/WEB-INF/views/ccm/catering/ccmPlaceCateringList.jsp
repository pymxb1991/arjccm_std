...
<ul class="back-list">
	<ul class="nav nav-tabs">
		<li class="active" style="width: 112px"><a class="nav-head" href="${ctx}/catering/ccmPlaceCatering/01">数据列表</a></li>
	</ul>
...
<%--			<li class="clearfix"></li>--%>
	...
	<div class="clearfix pull-right btn-box">
		<a
				onclick="parent.LayerDialog('${ctx}/catering/ccmPlaceCatering/form?type=01', '添加', '1100px', '700px')"
	...
	<table id="contentTable"
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmPlaceCatering">
				<tr>
					<td width="200px"><img
						src="${ccmPlaceCatering.ccmBasePlace.placePicture}"
						 class="pic-size pimg"/></td>
					<td><a class="btnList"
						onclick="parent.LayerDialog('${ctx}/catering/ccmPlaceCatering/form?id=${ccmPlaceCatering.id}', '编辑', '1100px', '700px')">${ccmPlaceCatering.placeName}</a></td>
