...
<body>
	<ul class="nav nav-tabs">
		<li><a style="width: 140px;text-align:center" href="${ctx}/work/ccmWorkNotice/">数据列表</a></li>
		<li class="active" style="width: 140px"><a class="nav-head" href="${ctx}/work/ccmWorkNotice/form?id=${ccmWorkNotice.id}">数据<shiro:hasPermission name="work:ccmWorkNotice:edit">${not empty ccmWorkNotice.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="work:ccmWorkNotice:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	<form:form id="inputForm" modelAttribute="ccmWorkNotice" action="${ctx}/work/ccmWorkNotice/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="content" htmlEscape="false" rows="30" maxlength="1000"  class="input-xxlarge "/>
