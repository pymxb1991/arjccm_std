...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/partyactivity/ccmPartyActivity/">党员活动管理列表</a></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="ccmPartyActivity">
			<tr>
				<td><a onclick="parent.parent.parent.LayerDialog('${ctx}/partyactivity/ccmPartyActivity/form?id=${ccmPartyActivity.id}', '修改', '1100px', '700px')">
				...
				<shiro:hasPermission name="partyactivity:ccmPartyActivity:edit"><td>
					...
					<a href="${ctx}/partyactivity/ccmPartyActivity/delete?id=${ccmPartyActivity.id}" onclick="return confirmx('确认要删除该党员活动管理吗？', this.href)">删除</a>--%>
						...
						<a  class="btnList"
							...
							onclick="return confirmx('确认要删除该党员活动信息吗？', this.href)" title="删除"><i class="icon-remove-sign"></i></a>
