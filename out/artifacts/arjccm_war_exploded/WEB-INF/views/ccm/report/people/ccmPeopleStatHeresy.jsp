...
<input type="hidden" id="hasPermission" value="${fns:getUser().hasPermission}"/>
			...
			<div class="ToAuto">
				<table class="table table-striped">
					<thead>
						<tr>
							<th>区域</th>
							<th title="本月涉教新增人数">本月涉教新增人数</th>
							<th title="本月涉教总数">本月涉教总数</th>
						</tr>
					</thead>
					<tbody class="body">
					</tbody>
			...
			<div class="ToAuto">
				<table class="table table-striped">
					<thead>
						<tr>
							<th>时间</th>
							<th title="新增涉教人数">新增涉教人数</th>
							<th title="涉教总人数">涉教总人数</th>
						</tr>
					</thead>
					<tbody class="body">
					</tbody>
	...
	<script type="text/javascript"
		src="${ctxStatic}/ccm/pop/js/ccmHeresyInfo.js"></script>
</body>
</html>