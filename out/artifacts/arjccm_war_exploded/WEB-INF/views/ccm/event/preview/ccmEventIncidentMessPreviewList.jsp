...
<ul class="back-list">
	<ul class="nav nav-tabs">
		<li style="float: right;"><a class="btn btn-danger"
			href="${ctx}/preview/ccmEventIncidentPreview/2?status=03" style="color: #ffffff">已拒绝</a></li>
		<li style="float: right;"><a class="btn btn-success"
			href="${ctx}/preview/ccmEventIncidentPreview/2?status=02" style="color: #ffffff">已通过</a></li>
		<li style="float: right;"><a class="btn btn-warning"
			href="${ctx}/preview/ccmEventIncidentPreview/2?status=01" style="color: #ffffff">未处理</a></li>
	...
	<form:form id="searchForm" modelAttribute="ccmEventIncidentPreview"
		action="${ctx}/preview/ccmEventIncidentPreview/2" method="post"
				...
				<tr>
					...
					<shiro:hasPermission name="preview:ccmEventIncidentPreview:edit">
						<td style="height: 50px"><a class="btnList"
							onclick="parent.LayerDialog('${ctx}/preview/ccmEventIncidentPreview/form/2?id=${ccmEventIncidentPreview.id}', '编辑', '1100px', '600px')"
							...
							<c:if test="${ccmEventIncidentPreview.status eq '03' || ccmEventIncidentPreview.status eq '02'}">
								<a  class="btnList" title="处理"><i class="icon-legal" style="color:  #656565;"></i></a>
							</c:if>
