...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="event:ccmEventRequestdeal:edit">
			<li class="active"><a
				href="${ctx}/event/ccmEventRequestdeal/dealform?eventRequestId=${ccmEventRequestdeal.eventRequestId}">请求处理<shiro:hasPermission
	...
	<form:form id="inputForm" modelAttribute="ccmEventRequestdeal"
		action="${ctx}/event/ccmEventRequestdeal/saveDeal" method="post"
	   ...
	   <table class="table table-bordered table-hover">
            <tr>
                ...
                <td class="pad"><form:input path="dealUnit" htmlEscape="false"
                        maxlength="200" class="input-xlarge " /></td>
                <td class="pad">请求负责人：</td>
                <td class="pad"><form:input path="eventPrincipal"
                        htmlEscape="false" maxlength="20" class="input-xlarge required" />
                	<span class="help-inline"><font color="red">*</font> </span>
            </tr>
            <tr>
                <td class="pad">个人电话：</td>
                <td class="pad"><form:input path="telPerson" htmlEscape="false"
                        maxlength="30" class="input-xlarge " /></td>
