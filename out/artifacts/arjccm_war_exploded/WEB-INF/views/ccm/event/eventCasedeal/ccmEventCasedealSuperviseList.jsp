...
<div class="context" content="${ctx}"></div>
	<ul class="nav nav-tabs">
		<li style="float:right;" class="active"><a style="background-color:#9f3df8;color:white;" href="${ctx}/event/ccmEventCasedeal/supervise?isSupervise=1">督办事件</a></li>
		<li style="float:right;"><a style="background-color:#25cf71;color:white;" href="${ctx}/event/ccmEventCasedeal/?handleStatus=03">已办事件</a></li>
		...
		<li style="float:right;"><a style="background-color:#f83d3d;color:white;" href="${ctx}/event/ccmEventCasedeal/?handleStatus=01">待办事件</a></li>
	...
	<form:form id="searchForm" modelAttribute="ccmEventCasedeal"
		action="${ctx}/event/ccmEventCasedeal/supervise?isSupervise=1" method="post"
