...
<body>
	<ul class="nav nav-tabs">
		<li><a style="width: 160px;text-align:center" href="${ctx}/event/ccmEventIncident/listLine">线、路案（事）件列表</a></li>
		<li class="active" style="width: 160px" ><a class="nav-head"
			href="${ctx}/event/ccmEventIncident/formLine?id=${ccmEventIncident.id}">线、路案（事）件<shiro:hasPermission
		...
		<shiro:hasPermission name="event:ccmEventCasedeal:edit">
			<li><a
				href="${ctx}/event/ccmEventCasedeal/dealformSDLine?eventIncidentId=${ccmEventIncident.id}">事件处理添加</a></li>
		</shiro:hasPermission>
		  -->
		<!--  只读处理权限  
	...
	<form:form id="inputForm" modelAttribute="ccmEventIncident"
		action="${ctx}/event/ccmEventIncident/saveLine" method="post"
				...
				<td>
					<div>
						...
						<div class="controls">
							...
							notAllowSelectParent="true" cssStyle="width: 220px" />
					...
					<div>
						...
						<div class="controls">
							<sys:treeselect id="line" name="line.id" value="${ccmEventIncident.line.id}" labelName="line.name" labelValue="${ccmEventIncident.line.name}"
								title="线、路名称" url="/event/ccmEventIncident/treeData" cssClass="" allowClear="true" notAllowSelectParent="true" cssStyle="width: 220px"/>
						</div>
					</div>
				</td>
			</tr>
...
<%--								<form:options items="${fns:getDictList('ccm_case_natu')}"--%>
			...
			<tr>
				<td >
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font></span> 主犯（嫌疑人）姓名：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font></span> 主犯（嫌疑人）证件代码：</label>
						<div class="controls">
