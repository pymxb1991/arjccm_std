	...
	<form:form id="inputForm" modelAttribute="user"
		...
		<table  style=" padding:0px 10px; width: 100%;">
					...
					<div class="control-group">
						...
						<div class="controls">
							<sys:treeselect id="company" name="company.id"
											...
											labelValue="${user.company.name}" title="组织机构"
			...
			<tr>
				<td>
					<div class="control-group">
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>手机:</label>
						<div class="controls">
				...
				<td>
					<div class="control-group">
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>是否允许登录:</label>
						<div class="controls">
			...
			<tr>
				...
				<td>
					<div class="control-group">
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>是否具有涉密资格:</label>
						<div class="controls">
							<form:select path="hasPermission">
								<form:options items="${fns:getDictList('yes_no')}"
											  itemLabel="label" itemValue="value" htmlEscape="false" />
							</form:select>
							<span class="help-inline">
					“是”代表此账号具有涉密资格，“否”则表示此账号无涉密资格</span>
						</div>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="control-group">
						<label class="control-label">涉密密码:</label>
						<div class="controls">
							<input id="permissionKey" name="permissionKey" type="password"
								   value="" maxlength="50" minlength="3" />
							<c:if test="${not empty user.id}">
								<span class="help-inline">若不修改涉密密码，请留空。</span>
							</c:if>
						</div>
					</div>
				</td>
