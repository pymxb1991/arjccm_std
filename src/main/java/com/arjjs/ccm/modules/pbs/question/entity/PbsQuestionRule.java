 ...
 * @version 2018-06-06
 */
public class PbsQuestionRule extends DataEntity<PbsQuestionRule> {
	
	private static final long serialVersionUID = 1L;
	private String sName;		// 评分规则名称
	...
	public PbsQuestionRule() {
		super();
	}

	public PbsQuestionRule(String id){
		super(id);
	}

	@Length(min=1, max=500, message="评分规则名称长度必须介于 1 和 500 之间")
	...
	@Length(min=0, max=11, message="难度级别赋值长度必须介于 0 和 11 之间")
