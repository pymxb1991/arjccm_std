 ...
 * @version 2018-05-15
 */
public class PbsActivityevaluate extends DataEntity<PbsActivityevaluate> {
	
	private static final long serialVersionUID = 1L;
	private PbsActivityrec sActivityid;		// 活动编号
	private String sContent;		// 评价描述信息
	private PbsPartymem sPartmember;		// 参与人员
	...
	public PbsActivityevaluate() {
		super();
	}

	public PbsActivityevaluate(String id){
		super(id);
	}

	
	@Length(min=0, max=2000, message="评价描述信息长度必须介于 0 和 2000 之间")
	...
	public PbsPartymem getsPartmember() {
		return sPartmember;
	}

	public void setsPartmember(PbsPartymem sPartmember) {
		this.sPartmember = sPartmember;
	}
