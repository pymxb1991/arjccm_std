 ...
 * @version 2018-04-11
 */
public class PbsQuestionMajor extends DataEntity<PbsQuestionMajor> {
	
	private static final long serialVersionUID = 1L;
	private String sName;		// 专业名称
	private String sDesc;		// 专业信息描述
	...
	public PbsQuestionMajor() {
		super();
	}

	public PbsQuestionMajor(String id){
		super(id);
	}

	@Length(min=1, max=500, message="专业名称长度必须介于 1 和 500 之间")
	...
	@Length(min=0, max=2000, message="专业信息描述长度必须介于 0 和 2000 之间")
