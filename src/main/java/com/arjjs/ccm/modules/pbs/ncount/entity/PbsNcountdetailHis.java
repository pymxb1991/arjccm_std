 ...
 * @version 2018-07-19
 */
public class PbsNcountdetailHis extends DataEntity<PbsNcountdetailHis> {
	
	private static final long serialVersionUID = 1L;
	private PbsNcountHis sParentid;		// 统计类别
	private String sName;		// 统计名称
	private String iNumber;		// 统计总数
	...
	public PbsNcountdetailHis() {
		super();
	}

	public PbsNcountdetailHis(String id){
		super(id);
	}

	@Length(min=0, max=100, message="统计名称长度必须介于 0 和 100 之间")
	...
	@Length(min=0, max=50, message="统计总数长度必须介于 0 和 50 之间")
	...
	public PbsNcountHis getsParentid() {
		return sParentid;
	}

	public void setsParentid(PbsNcountHis sParentid) {
