...
import com.arjjs.ccm.common.persistence.BaseEntity;
import com.arjjs.ccm.common.utils.StringUtils;
import com.arjjs.ccm.common.utils.TimeUtils;
import com.arjjs.ccm.modules.act.utils.Variable;
...
//	private String procExecUrl; 	// 流程执行（办理）RUL
	...
	private HistoricProcessInstance historicProcIns;	// 历史流程实例对象
...
//	private Variable taskVars; 	// 流程任务变量
	...
	public HistoricProcessInstance getHistoricProcIns() {
		return historicProcIns;
	}

	public void setHistoricProcIns(HistoricProcessInstance historicProcIns) {
		this.historicProcIns = historicProcIns;
	
		if (historicProcIns != null && historicProcIns.getBusinessKey() != null){
			String[] ss = historicProcIns.getBusinessKey().split(":");
			setBusinessTable(ss[0]);
			setBusinessId(ss[1]);
		}
	}
