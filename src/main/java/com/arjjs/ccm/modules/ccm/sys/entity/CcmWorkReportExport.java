 ...
 * @version 2018-03-08
 */
public class CcmWorkReportExport extends DataEntity<CcmWorkReportExport> {
	...
	public CcmWorkReportExport() {
		super();
	}

	public CcmWorkReportExport(String id){
		super(id);
	}
	...
	@ExcelField(title="日志时间范围", align=2, sort=4)
	public String getDateRange(){
		SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
		String beginString = formatter.format(beginDate);
	...
	@ExcelField(title="查阅状态", align=2, sort=6)
	public String getReadNumStatus(){
		Integer sum = Integer.parseInt(this.readNum) + Integer.parseInt(this.unReadNum);
		return     this.readNum +"/" + sum.toString();
	}
