 ...
 * @version 2018-03-08
 */
public class CcmEventExport extends DataEntity<CcmEventExport> {
	...
	public CcmEventExport() {
		super();
	}

	public CcmEventExport(String id){
		super(id);
	}
	...
	@ExcelField(title="日志时间范围", align=2, sort=3)
