...
//		view += ".jsp";
	...
	public String indexStat(HttpServletRequest request, HttpServletResponse response) {
		Principal principal = UserUtils.getPrincipal();
...
//		try {
//			byte[] bytes = com.arjjs.ccm.common.utils.FileUtils.readFileToByteArray(
//					com.arjjs.ccm.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
...
//		return "modules/sys/sysIndex";
	 ...
	 */
	@RequiresPermissions("user")
	@RequestMapping(value = "${appPath}/index")
