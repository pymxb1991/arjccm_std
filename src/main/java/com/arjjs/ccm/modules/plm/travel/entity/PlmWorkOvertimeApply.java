 ...
 * @version 2018-07-16
 */
public class PlmWorkOvertimeApply extends ActEntity<PlmWorkOvertimeApply> {
	...
	private String applyType;		// 加班类型
	private Double days;		// 加班时长
	...
	public PlmWorkOvertimeApply() {
		super();
	}

	public PlmWorkOvertimeApply(String id){
		super(id);
	}
